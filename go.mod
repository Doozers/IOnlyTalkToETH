module github.com/Doozers/IOnlyTalkToETH
...
require (
	...
	github.com/Doozers/BasicPublicKeyEncryption v0.0.0-20220816143831-f682aa979f5c
	github.com/Doozers/ETH-Signature v0.0.0-20220817203846-800ce1e3eeac
